...
def add_movie():
    ...
    directory = input("Enter the name of the director: ")
    relase_date = input("Enter the release date of the movie: ")
    actors = input("Enter the actors in the movie (seperated by commas): ")
...
# Function to edit an exisiting movie in the database
def edit_movie():
    ...
    if title in movie_database:
        ...
        # Promnt user to update information
        ...
        release_date = input("Enter the realse date of the movie (YYYY-MM-DD) (or press enter to keep current value): ")
        actors = input("Enter the name of the actors (separated by commas) (or press enter to keep current value): ")
        actors_list = actors.split(", ")
        ...
        print(f"{title} is not int he database.")
...
# Function to search for a movie on user-specified criteria
def search_movies():
...
# Function to save movie to a file
def save_data():
...
# Main program loop
while True:
    print("\n==== Movie Databse Management System ====\n")
